...
OAOAOAOAOAOAOAOAOAOAOAOA            self.assertEqual(correct, output.getvalue().strip())
OAOAOAOAOAOAOA        with patch("sys.stdout", new=StringIO()) as output:
OAOAOAOAOA            self.assertFalse(HBNBCommand().onecmd("City.update()"))
OA            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
OA            self.assertFalse(HBNBCommand().onecmd("Amenity.update()"))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
